...
RSpec.describe "Forecast API", :vcr do
  describe "can send forecast details by location" do
    scenario "can retrive weather by location as index action" do
      ...
      expect(current_forecast[:temp]).to be_a(String)
      expect(current_forecast).to have_key(:feels_like)
      expect(current_forecast[:feels_like]).to be_a(String)
      ...
      expect(daily_forecast.first[:max_temp]).to be_a(String)
      expect(daily_forecast.first).to have_key(:min_temp)
      expect(daily_forecast.first[:min_temp]).to be_a(String)
      ...
      expect(hourly_forecast.first[:temp]).to be_a(String)
